...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "k_ion");
 	...
 	ivoc_help("help ?1 kap /home/fernando/Dropbox/Biestabilidade-HH/BistabilityHH/info/CA1-NetPyNE-model-master/x86_64/kap.mod\n");
...
double alpn (  double _lv ) {
   double _lalpn;
 _lalpn = - 0.01 * ( _lv + 21.3 ) / ( exp ( ( _lv + 21.3 ) / - 35.0 ) - 1.0 ) ;
...
double betn (  double _lv ) {
   double _lbetn;
 _lbetn = 0.01 * ( _lv + 21.3 ) / ( exp ( ( _lv + 21.3 ) / 35.0 ) - 1.0 ) ;
 ...
 v=_v;
{
  ek = _ion_ek;
 { error =  states();
 if(error){fprintf(stderr,"at line 57 in file kap.mod:\n	SOLVE states\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/fernando/Dropbox/Biestabilidade-HH/BistabilityHH/info/CA1-NetPyNE-model-master/mod/kap.mod";
static const char* nmodl_file_text = 
