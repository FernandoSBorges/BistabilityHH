...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 0, "cvodeieq");
 	...
 	ivoc_help("help ?1 h /home/fernando/Dropbox/Biestabilidade-HH/BistabilityHH/info/CA1-NetPyNE-model-master/x86_64/h.mod\n");
...
{
 { error =  states();
 if(error){fprintf(stderr,"at line 49 in file h.mod:\n	SOLVE states METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 }}}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/fernando/Dropbox/Biestabilidade-HH/BistabilityHH/info/CA1-NetPyNE-model-master/mod/h.mod";
static const char* nmodl_file_text = 
